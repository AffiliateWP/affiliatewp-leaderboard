 ...
 */
class AffiliateWP_LB_Requirements_Check extends AffiliateWP_Requirements_Check {
	 ...
	 * @var   string
	 */
	protected $slug = 'affiliatewp-leaderboard';
	...
	public function bootstrap() {
		if ( ! class_exists( 'Affiliate_WP' ) ) {
			...
			\AffiliateWP_Leaderboard::instance( __FILE__ );
		}
	}
	...
	protected function load() {
		...
		if ( ! class_exists( 'AffiliateWP_Leaderboard' ) ) {
			require_once dirname( __FILE__ ) . '/includes/class-affiliatewp-leaderboard.php';
		}
	...
	public function install() {
		...
		if ( defined( 'AFFWP_LB_VERSION' ) ) {
			update_option( 'affwp_lb_version', AFFWP_LB_VERSION );
		}
	}
	...
	protected function unmet_requirements_label() {
		return esc_html__( 'AffiliateWP - Leaderboard Requirements', 'affiliatewp-leaderboard' );
	}
	...
	protected function unmet_requirements_name() {
		return 'affiliatewp-leaderboard-requirements';
	}
...
$requirements = new AffiliateWP_LB_Requirements_Check( __FILE__ );
