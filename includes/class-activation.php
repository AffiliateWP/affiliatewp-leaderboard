...
class AffiliateWP_Activation {
	...
	public function __construct( $plugin_path, $plugin_file ) {
		...
		if ( isset( $plugins[$this->plugin_path . '/' . $this->plugin_file]['Name'] ) ) {
			...
			$this->plugin_name = __( 'This plugin', 'affiliatewp-leaderboard' );
		}
	...
	public function missing_affiliatewp_notice() {
		...
		if ( $this->has_affiliatewp ) {
		   echo '<div class="error"><p>' .  $this->plugin_name . sprintf( __( ' requires %sAffiliateWP%s. Please activate it to continue.', 'affiliatewp-leaderboard' ), '<a href="http://affiliatewp.com/" title="AffiliateWP" target="_blank">', '</a>' ) . '</p></div>';

		} else {
			echo '<div class="error"><p>' . $this->plugin_name . sprintf( __( ' requires %sAffiliateWP%s. Please install it to continue.', 'affiliatewp-leaderboard' ), '<a href="http://affiliatewp.com/" title="AffiliateWP" target="_blank">', '</a>' ) . '</p></div>';
		}
	}
}
